...
TShader::TShader( std::string const & vertexShaderText, std::string const & fragmentShaderText )
{
    const GLchar* vShaderCode = vertexShaderText.c_str();
    const GLchar* fShaderCode = fragmentShaderText.c_str();
